package com.gl.labsix.controller;
...
import com.gl.labsix.service.StudentService;
...
public class StudentController {
	...
	@PostMapping("/save")
	public String saveStudent(@RequestParam("id") Integer id, @RequestParam("fname") String fname,
